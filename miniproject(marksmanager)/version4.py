...
while True:
    ...
    try:
        ...
        if choice == 10:
            ...
            with open('D:\Learning\Github\python-basics\miniproject(marksmanager)\marks.txt', "r", encoding="utf-8") as file:
                student = file.read()
            while True:
                try:
                    ...
                    if name in student:
                        ...
                        student[name] = marks
                        with open(r'D:\Learning\Github\python-basics\miniproject(marksmanager)\marks.txt', "a") as file:
                ...
                with open('D:\Learning\Github\python-basics\miniproject(marksmanager)\marks.txt', "r") as file:
                    print(file.read())
